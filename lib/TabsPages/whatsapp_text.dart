...
class TextHomePage extends StatefulWidget {
  ...
  @override
  State<TextHomePage> createState() => _ImageHomePageState();
}

class _ImageHomePageState extends State<TextHomePage> {
              ...
              : ListTile(
                  ...
                  subtitle: GridView(
                    ...
                    children: List.generate(
                      file.getWAText.length,
                      (index) {
                        final data = file.getWAText;
